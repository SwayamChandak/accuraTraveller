...
def get_menu(url, save=True, print_html=True):
    ...
    if print_html:
        ...
        restaurant_slug = url.split('/')[-2]  # -2 because /order is added
        with open(f"scraped_html/zomato_menu_{restaurant_slug}.html", "w", encoding="utf-8") as f:
            f.write(webpage.text)
        print(f"✓ Full HTML saved to: scraped_html/zomato_menu_{restaurant_slug}.html\n")
